  ...
  return (
    <div>
      ...
      <LinearProgress
        ...
        color={
          (progress.label === 'Davomat' && 'warning') ||
          (progress.label === "O'quv natijalari" && 'info') ||
          (progress.label === 'Ota-onalar mamnuniyati' && 'error') ||
          (progress.label === 'Moliyaviy yig`im' && 'success') ||
          (progress.label === "O'quvchilar faolligi" && 'secondary') ||
          'primary'
        }
        sx={{
          height: 8,
